...
- [Hugging Face model card — English](https://huggingface.co/yigu666/DenseK3-4B/blob/main/README.md)
- [Hugging Face model card — 中文](https://huggingface.co/yigu666/DenseK3-4B/blob/main/README_zh.md)
...
- Standalone export parity and file hashes: [`release/RELEASE_VALIDATION.md`](release/RELEASE_VALIDATION.md) and the [Hub parity summary](https://huggingface.co/yigu666/DenseK3-4B/blob/main/PARITY_SUMMARY.json).
